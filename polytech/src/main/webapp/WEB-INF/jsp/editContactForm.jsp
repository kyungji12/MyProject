...
function duplication(type, contact){
	...
	$(document).ready(function() {
		$("select option[value='${contact.type}']").attr("selected", true);
	});
	////////연락처 유효성 검사		
...
<body>
	<div class="container">
		<form name="insert" onsubmit='return input_check();' method="POST"
			action="/saveContact.html">
			<h2>${oneViewCon.name}님의연락처 수정</h2>
			...
			<select name="type" id="type" required>
			 ...
			 <label for="email"><i class="fa fa-user"></i>번호</label> 
			 <input type="text" name="contact" id="contact" maxlength="11"
				value="${contact.contact} " placeholder="'-'는 자동생성 됩니다.">
						 <script>
			...
			<div style="text-align: center;">
				<input type="submit" value="수정" disabled id="editBtn" name="editBtn" class="btn"> <input
